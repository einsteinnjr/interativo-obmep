...
function fillAnswerTriangleConstructable(){
	...
	if(typeOfTriangle===NO_TRIANGLE){
		$("#answerTriangleConstructable").html("<strong>a)</strong>Ao analisarmos, utilizando a Desigualdade Triangular relativa ao maior lado (a="+a+"):<br/> Para existir triângulo, deve ser verdade a desigualdade:<br/> b + c > a, ou seja, "+b+" + "+c+" > "+a+", ou seja, "+sum+" > "+a+" <i class='glyphicon glyphicon-remove'>Falso!</i> <br/> Logo, NÃO é possível construir triângulo com as 3 varetas dadas: a="+a+", b="+b+", c="+c+".");
	}else{
		$("#answerTriangleConstructable").html("<strong>a)</strong>Ao analisarmos, utilizando a Desigualdade Triangular relativa ao maior lado (a="+a+"):<br/> Para existir triângulo, deve ser verdade a desigualdade:<br/> b + c > a, ou seja, "+b+" + "+c+" > "+a+", ou seja, "+sum+" > "+a+" <i class='glyphicon glyphicon-ok'>Verdade!</i> <br/> Logo, <strong>É possível construir triângulo</strong> com as 3 varetas dadas: a="+a+", b="+b+", c="+c+".");
	}
}
